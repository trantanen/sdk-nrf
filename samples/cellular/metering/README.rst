...
The Metering sample demonstrates how the host MCU can use the :ref:`Serial LTE Modem <slm_description>` application running on nRF91 Series SiP for a metering use case.
