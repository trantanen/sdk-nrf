...
The |NCS| includes :ref:`nrf53_audio_app`, which integrate the LE Audio standard with custom reference hardware based on the nRF5340 DK.
...
The build target for the network core in Zephyr is ``nrf5340dk/nrf5340/cpunet``.
...
* ``nrf5340dk/nrf5340/cpuapp`` for build targets with CMSE disabled.
* ``nrf5340dk/nrf5340/cpuapp/ns`` for build targets that have CMSE enabled and have the SPE firmware alongside the NSPE firmware.
...
.. |vsc_sample_board_target_line| replace:: select ``nrf5340dk/nrf5340/cpuapp`` or ``nrf5340dk/nrf5340/cpuapp/ns`` as the target board
